...
from Executor.ExecutorUtils.NotificationCenter.Telegram.telegram_adapter import send_telegram_async_message
...
def send_notice():
    ...
    if st.button("Send Notice"):
        ...
        for user in active_users:
            send_telegram_async_message(user["Profile"]["PhoneNumber"], user_input)
            sleep(1)
