...
while true; do
    ...
    /Users/traderscafe/miniconda3/envs/tradingenv/bin/python Executor/Scripts/WeeklyReports/WeeklyReport.py && \
    ...
    if ((attempt==max_attempts)); then
        echo "The script Weekly Report has some errors. Please Check !!!"
