...
while true; do
    ...
    /Users/traderscafe/miniconda3/envs/tradingenv/bin/python Executor/Scripts/2_GoodEvening/3_EODTradeDBLogging/EODDBLog.py && \
    ...
    if ((attempt==max_attempts)); then
        echo "The script Trade DB Logging has some errors. Please Check !!!"
        
        # Send a message on Telegram
        curl -s -X POST https://api.telegram.org/bot$telegram_bot_token/sendMessage -d chat_id=$chat_id -d text="Trade DB Logging errors. Please Check !!!"
