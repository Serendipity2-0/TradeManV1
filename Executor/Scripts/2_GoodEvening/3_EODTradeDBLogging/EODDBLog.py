        ...
        for strategy_name, strategy_details in strategies.items():
            ...
            for order in orders:
                ...
                entry_orders = [
                    o
                    for o in orders
                    if trade_id_prefix in o["trade_id"]
                    and "EN" in o["trade_id"]
                    and "HO" not in o["trade_id"]
                ]
                exit_orders = [
                    o
                    for o in orders
                    if trade_id_prefix in o["trade_id"]
                    and "EX" in o["trade_id"]
                    and "HO" not in o["trade_id"]
                ]
                hedge_orders = [
                    o
                    for o in orders
                    if trade_id_prefix in o["trade_id"] and "HO" in o["trade_id"]
                ]
            ...
            exit_price = sum([float(o["avg_prc"]) for o in exit_orders]) / len(
                exit_orders
            )
