...
while true; do
    ...
    /Users/traderscafe/miniconda3/envs/tradingenv/bin/python Executor/Scripts/2_GoodEvening/4_EODDailyReports/EODReport.py && \
    ...
    if ((attempt==max_attempts)); then
        echo "The script EOD report has some errors. Please Check !!!"
        
        # Send a message on Telegram
        curl -s -X POST https://api.telegram.org/bot$telegram_bot_token/sendMessage -d chat_id=$chat_id -d text="EOD report errors. Please Check !!!"
