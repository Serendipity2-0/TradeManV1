...
def create_market_info_df():
    ...
    for strategy_name, strategy_info in strategy_fb_data.items():
        ...
        strategy_type = strategy_info.get('GeneralParams', {}).get('StrategyType', 'N/A')
        ...
        qty_amplifier = strategy_info.get('MarketInfoParams', {}).get('EquityQtyAmplifier',
                            strategy_info.get('MarketInfoParams', {}).get('OBQtyAmplifier',
                            strategy_info.get('MarketInfoParams', {}).get('OSQtyAmplifier', 'N/A')))

        strategy_amplifier = strategy_info.get('MarketInfoParams', {}).get('StrategyQtyAmplifier', 'N/A')
