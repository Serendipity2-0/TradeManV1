"""
This module contains price calculation utility functions for NSE strategies.
"""
...
def calculate_stoploss(
    ...
    if stoploss_multiplier:
        return calculate_multipler_stoploss(
        ...
        raise ValueError(
            "Invalid stoploss calculation: need either multiplier or price reference"
        )

def calculate_multipler_stoploss(
    main_transaction_type: str, ltp: float, stoploss_multiplier: float
) -> float:
    """
...
def calculate_priceref_stoploss(
    main_transaction_type: str, ltp: float, price_ref: float
) -> float:
    """
...
def get_hedge_strikeprc(
    base_symbol: str, token: int, prediction: str, hedge_multiplier: int
) -> float:
    """
