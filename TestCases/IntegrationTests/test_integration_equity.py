...
DATA_DIR = os.path.join(BASE_DIR, "Data")  # Adjust this to the relative path you need

ORIGINAL_DB_PATH = os.path.join(DATA_DIR, "stock_picks.db")
TEST_DB_PATH = os.path.join(DATA_DIR, "stock_picks_test.db")

ENV_PATH = os.path.join(BASE_DIR, "trademan.env")
load_dotenv(ENV_PATH)
