...
SCRIPT_DIR = (
    r"C:\Users\phchi\OneDrive\Desktop\TradeManV1\Executor\NSEStrategies\Equity\MidTerm"
)
sys.path.append(SCRIPT_DIR)

from MidTermUtils import (
...
@patch("MidTermUtils.read_stock_data_from_db")
@patch("MidTermUtils.calculate_sma")
@patch("MidTermUtils.indicator_rsi")
@patch("MidTermUtils.pd.read_sql_query")
...
@patch("MidTermUtils.read_stock_data_from_db")
@patch("MidTermUtils.calculate_sma")
@patch("MidTermUtils.calculate_ema")
@patch("MidTermUtils.indicator_rsi")
@patch("MidTermUtils.pd.read_sql_query")
...
@patch("MidTermUtils.perform_tfmomentum_strategy")
@patch("MidTermUtils.perform_tfema_strategy")
