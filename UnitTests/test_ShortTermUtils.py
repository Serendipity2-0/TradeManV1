...
SCRIPT_DIR = r"C:\Users\phchi\OneDrive\Desktop\TradeManV1\Executor\NSEStrategies\Equity\ShortTerm"
...
@patch("ShortTermUtils.indicator_bollinger_bands")
@patch("ShortTermUtils.indicator_50ema")
...
@patch("ShortTermUtils.indicator_rsi")
@patch("ShortTermUtils.indicator_bollinger_bands")
@patch("ShortTermUtils.check_if_above_50ema")
...
@patch("ShortTermUtils.indicator_bollinger_bands")
@patch("ShortTermUtils.check_if_above_50ema")
@patch("ShortTermUtils.indicator_macd")
...
@patch("ShortTermUtils.read_stock_data_from_db")
@patch("ShortTermUtils.perform_momentum_strategy")
@patch("ShortTermUtils.perform_mean_reversion_strategy")
@patch("ShortTermUtils.perform_EmaBB_Confluence_strategy")
